...
myTmux :: String
myTmux = "kitty -e tmux"    -- Sets tmux multiplexer
...
--  spawn "killall conky"   -- kill current conky on each restart
  ...
  spawnOnce "lxsession"
--  spawnOnce "picom"
  spawnOnce "picom -b --experimental-backends --backend glx" --this enables Gausiian Blurring in picom
  spawnOnce "nm-applet"
...
myKeys c =
  ...
  , ("M1-<Return>", addName "Launch tmux"      $ spawn (myTmux))
